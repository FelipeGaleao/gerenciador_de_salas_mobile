package com.meicansoftware.gerenciasala.pages.courses;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    case  R.id.nav_login:
                        ...
                        Intent intent = new Intent(Courses.this, Login.class);
                        startActivity(intent);
                        break;

                    case  R.id.nav_signup:
                        Intent intent2 = new Intent(Courses.this, Signup.class);
                        startActivity(intent2);
                        break;

                    case R.id.nav_courses:
                        Intent intent3 = new Intent(Courses.this, Courses.class);
                        startActivity(intent3);
                        break;

                    case R.id.nav_events:
                        Intent intent4 = new Intent(Courses.this, Events.class);
                        startActivity(intent4);
                        break;

                    case R.id.nav_reservations:
                        Intent intent5 = new Intent(Courses.this, Reservations.class);
                        startActivity(intent5);
                        break;

                    case R.id.nav_home:
                        Intent intent_home = new Intent(Courses.this, Home.class);
