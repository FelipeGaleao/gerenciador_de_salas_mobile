...
public class RoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            String rooms = roomService.get_rooms();
            // parse json to list
            
            // create a new adapter
            MyRoomRecyclerViewAdapter adapter = new MyRoomRecyclerViewAdapter(roomsLoaded);
            ...
            Toast.makeText(getActivity(), rooms, Toast.LENGTH_LONG).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
